...
from .regist_views import RegistrationAPIView, VerifyRegistrationAPIView
...
urlpatterns = [
    ...
    path('api/register/', regist_views.RegistrationAPIView.as_view(), name='api_register'),
    path('api/verify-registration/', regist_views.VerifyRegistrationAPIView.as_view(), name='api_verify_registration'),
